...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    @Transactional
    public ResponseEntity<?> updateQuestion(UpdateAnswerOfQuestionRequest updateAnswerOfQuestionRequest, Long id) {
        ...
        addQuestion(new QuestionRequest(question.getLabel(), updateAnswerOfQuestionRequest.getAnswerRequest(), updateAnswerOfQuestionRequest.getRightAnswerPosition()));
